...
ADHD-ს არსებობის ზუსტი მიზეზი არავინ იცის, არსებობს ბევრი თეორია, რამდენიმე მოცემულია სტატიის ბოლოს.
...
რომლებიც ნაკლებად ეფექტურები არიან მედიკამენტზე, ორი სიტყვით რომ ითქვას, "არაფერს ჯობია".
...
# თეორიები
ADHD-ს არსებობის ზუსტი მიზეზი არავინ იცის, არსებობს ბევრი თეორია.

### მონადირეების და ფერმერების თეორია.
...
(სავარაუდოდ "ბუნებრივი გადარჩევის" მეთოდით)

როგორც სტატიის თავში ვახსენე, დღეს ყველას გვიწევს, სკოლა, სწავლა, ხანგრძლივი სამუშაო და კარიერული წინსვლა,
რის გამოც, ADHD აშლილობად გამოვლინდა თამანედროვე დროში.

### სტრესულ გარემოს თეორია
--  ამ თეორიას მომავალში ჩავამატებ --
